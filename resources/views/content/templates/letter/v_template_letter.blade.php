            ...
            <div class="col-md-3">
                ...
                <div class="nav flex-column nav-pills nav-pills-custom" id="v-pills-tab" role="tablist"
                    ...
                    <a class="nav-link mb-3 p-3 shadow active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home"
                        ...
                        <span class="font-weight-bold small text-uppercase">Surat Kelulusan</span></a>

                    <a class="nav-link mb-3 p-3 shadow" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile"
                        role="tab" aria-controls="v-pills-profile" aria-selected="false">
                        <i class="fa fa-calendar-minus-o mr-2"></i>
                        <span class="font-weight-bold small text-uppercase">Surat Keputusan</span></a>
            ...
            <div class="col-md-9">
                ...
                <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade shadow rounded bg-white show active p-5" id="v-pills-home" role="tabpanel"
                        ...
                        <h4 class="font-italic mb-4">Pengaturan Surat Kelulusan</h4>
                        <hr>
                        <div class="content">
                            ...
                            <div class="m-checkbox-inline">
                                @foreach ($template as $tem)
                                    <label class="m-checkbox">
                                        <input type="checkbox" name="id_template[{{ $tem['id'] }}]"> {{ $tem['name'] }}
                                        <span></span>
                                    </label>
                                @endforeach
                            </div>
                    ...
                    <div class="tab-pane fade shadow rounded bg-white p-5" id="v-pills-profile" role="tabpanel"
                        ...
                        <p class="font-italic text-muted mb-2">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed
